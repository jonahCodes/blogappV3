[x]form needs functioning
[x]navbar
[x]showpage
[]Fully devlope showpage
[x]delete forms post
[]updates forms post
[]add drop list admin delete and update on showindex.js replace that basic button
[]make a user schema &&login

  {
    []passport auth() on creating a form and updating and deleting
    1[]
  }

[]RE:theme making a tech web app
[]fix Jquery footer and links format
[]make get in touch feature with something else 
[]add navbar drop drowns 
[]Fix mobile responsive

{
[]let try to invent ideas or ways to make this web site craiglist selling pc and other gooD tech stuff
1[]
}
[]find more feature to practices 
[]make this site so ifo on selling IM pc to the customer ecommerce style used
